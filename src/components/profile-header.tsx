  ...
  return (
    <div className="detail-cards-grid detail-cards-grid--profile">
      ...
      <div className="profile-card">
        ...
        {agency.rating > 0 && (
          <div className="profile-card-rating-row">
            <Stars rating={agency.rating} size={16} />
            {reviews.length > 0 && (
              <span className="profile-card-rating-count">{reviews.length} hodnoceni</span>
            )}
          </div>
        )}
      </div>
      ...
      <div className="profile-card">
        ...
        {agency.description ? (
          ...
          <p className="profile-card-empty">Zatim bez popisu</p>
        )}
...
export function BrokerProfileHeader({ broker, agency, reviews }: BrokerProfileHeaderProps) {
  return (
    <div className="detail-cards-grid detail-cards-grid--profile">
      {/* Card 1: About + Contact */}
      <div className="profile-card">
        <div className="profile-card-header">
          <div className={`profile-card-avatar ${!broker.photo ? "profile-card-avatar--placeholder" : ""}`}>
            {broker.photo ? (
      ...
      <div className="profile-card">
        ...
        {broker.rating > 0 && (
          <div className="profile-card-rating-row">
            <Stars rating={broker.rating} size={16} />
            {reviews.length > 0 && (
              <span className="profile-card-rating-count">{reviews.length} hodnoceni</span>
            )}
          </div>
