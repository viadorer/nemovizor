      ...
      .then((res) => {
        if (res.data && Array.isArray(res.data)) {
          ...
          for (const b of res.data) {
            map[b.id] = b.name + (b.city ? ` (${b.city})` : "") + (b.is_headquarters ? " - hlavni" : "");
          }
          setBranches(map);
        }
      })
  ...
  if (success) {
    return (
      <div className="pf-success">
        ...
        <h3>{mode === "create" ? "Makler vytvoren" : "Makler ulozen"}</h3>
        <p>{"Presmerovavam..."}</p>
      </div>
    );
  }
  ...
  return (
    <div className="pf-main">
      ...
      <div className="pf-header">
        ...
        <h2>{mode === "create" ? "Novy makler" : "Upravit maklere"}</h2>
      </div>
      ...
      <div className="admin-form-grid">
        ...
        {agencyId && Object.keys(branches).length > 0 && (
          <SelectField
            ...
            options={branches}
            placeholder="-- Zadna pobocka --"
          />
        )}
      </div>

      <SingleImageUpload
        label="Profilova fotka"
        value={photo}
        onChange={setPhoto}
        shape="round"
        size={96}
      ...
      <div className="admin-form-grid">
        <div className="admin-form-full">
          <TextareaField
            ...
            value={bio}
            onChange={setBio}
            placeholder="Kratky popis maklere..."
            rows={4}
          />
        </div>
        ...
        <TextField
          ...
          placeholder="Rezidencni nemovitosti"
        />
        <NumberField
          label="Rok zahajeni cinnosti"
          value={yearStarted}
        ...
        <TagsField
          ...
          placeholder="Pridat jazyk..."
        />
        <TagsField
          label="Certifikace"
          value={certifications}
          onChange={setCertifications}
          placeholder="Pridat certifikaci..."
        />
      ...
      <div className="pf-actions">
        ...
        >
          ...
          {mode === "create" ? "Vytvorit maklere" : "Ulozit zmeny"}
        </button>
      </div>
    </div>
  );
