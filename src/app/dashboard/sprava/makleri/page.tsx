  ...
  return (
    <div className="dashboard-page">
      <DataTable<BrokerRow>
        ...
        fetchData={fetchData}
        rowKey={(row) => row.id}
        searchPlaceholder="Hledat podle jmena, emailu, kancelare..."
      ...
      <ConfirmDialog
        open={!!archiveId}
        title="Archivovat maklere"
        message="Opravdu chcete tohoto maklere archivovat? Tuto akci lze pozdeji vratit."
