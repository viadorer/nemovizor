    ...
    <div className="page-shell">
      ...
      <section className="agency-hero">
        <div className="agency-hero-inner">
          {agency.logo && <img src={agency.logo} alt={agency.name} className="agency-hero-logo" />}
          {!agency.logo && (
            <div className="agency-hero-logo-placeholder">
              <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1"><path d="M3 21h18M3 7v14M21 7v14M6 11h.01M6 15h.01M12 11h.01M12 15h.01M18 11h.01M18 15h.01M6 7V3h12v4" /></svg>
            </div>
          )}
          ...
          <div className="agency-hero-contacts">
            ...
            {agency.email && (
              <a href={`mailto:${agency.email}`} className="broker-hero-btn broker-hero-btn--secondary">
            ...
            {agency.website && (
              <a href={agency.website} target="_blank" rel="noopener" className="broker-hero-btn broker-hero-btn--secondary">
