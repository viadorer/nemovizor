    ...
    try {
      const res = await fetch("/api/valuation/estimate", {
        ...
        body: JSON.stringify({
          ...
          floorArea: form.propertyType !== "land" ? (Number(form.area) || undefined) : undefined,
          lotArea: form.propertyType === "land" ? (Number(form.area) || undefined) : (Number(form.areaLand) || undefined),
